...
# Bot Information
API_ID = int(environ.get("API_ID", "29290111"))
API_HASH = environ.get("API_HASH", "f6a2bd2b9aa6aa06fbba8c14a3fba29d")
BOT_TOKEN = environ.get("BOT_TOKEN", "")

PICS = (environ.get('PICS', 'https://graph.org/file/ce1723991756e48c35aa1.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6161643477').split()]
...
DB_URI = environ.get("DB_URI", "mongodb+srv://lijil33365:fyfygi6yt@cluster0.tamiz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002153233058"))
